...
## Homework #5 ##
#################
# K Folds Cross, multinomial logistic, Decision Trees, Random Forest
#Specify your name
...
# IF ONLY ONE MODEL IS NEEDED FOR GRADING PURPOSES, PLEASE LOOK TO THE MEAN F1 ON THE DECISION TREE CLASSIFICATION MODEL. 
...
# Format into myPredictions data frame
...
# Bind to existing myPredictions data frame
