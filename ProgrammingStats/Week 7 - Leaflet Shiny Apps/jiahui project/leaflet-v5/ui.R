  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      tabsetPanel(type="tabs",
                  ...
                  #Add a tab for problem description (Use tabPanel for each individual panel)
                  tabPanel("Problem Description", textOutput("text")),
                  # The text is what we call out and fill in server (Just like with map below for the second tab)
