...
plot <- ggplot(degrees, aes(x = year, y = female.ratio, color = discipline)) + geom_line() + theme_classic()
plot
...
# Snowball testing -> Get people to continue looking at your graph (It's kind of User experience testing) and giving you feedback (Even small things like I don't like the color red in this graph)
